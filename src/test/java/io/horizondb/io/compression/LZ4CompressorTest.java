...
public class LZ4CompressorTest {
    ...
    @Test
    public void testCompressionWithArray() throws IOException {
        ...
        ReadableBuffer compressedData = compressor.compress(Buffers.wrap(array));
        
        LZ4Decompressor decompressor = new LZ4Decompressor();
        
        ReadableBuffer uncompressedData = decompressor.decompress(compressedData, decompressedLength);

        assertArrayEquals(array, ((Buffer) uncompressedData).array());
    }
    
    @Test
    public void testCompressionWithNonHeapBuffer() throws IOException {
