...
/**
 * <code>FileDataOutput</code> that use a direct buffer to write to the underlying file.
 * 
 * @author Benjamin
 * 
 */
public class DirectFileDataOutput extends AbstractByteWriter implements FileDataOutput {
    ...
    /**
     * Creates a new <code>DirectDataOutput</code> to write data to the specified file.
     * 
    ...
    /**
     * Flush the buffer if there are not enough space for the specified number of bytes.
     * 
