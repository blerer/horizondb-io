...
/**
 * <code>SeekableFileDataOutput</code> that use a memory mapped byte buffer to write to the underlying file.
 * 
 * @author Benjamin
 * 
 */
public final class MemoryMappedFileDataOutput extends AbstractByteWriter implements SeekableFileDataOutput {
    ...
    /**
     * Creates a new <code>MemoryMappedFileDataOutput</code> to write data to the specified file.
     * 
