...
public final class TruncatedSeekableFileDataInput implements SeekableFileDataInput {
    ...
    /**
     * Creates a <code>TruncatedSeekableFileDataInput</code> that truncate the specified input to the specified length.
     * 
    ...
    /**
     * Creates a <code>TruncatedSeekableFileDataInput</code> that truncate the specified input to the part specified by
