...
public final class Serializables<T extends Serializable> implements Iterable<T>, Serializable {
    ...
    public static <S extends Serializable>
            Serializables<S>
            parseFrom(Parser<S> parser, ByteReader reader) throws IOException {
    ...
    public boolean equals(Object object) {
        ...
        return new EqualsBuilder().append(this.serializables, rhs.serializables).isEquals();
    }
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder(252469533, 1404885147).append(this.serializables).toHashCode();
    }
