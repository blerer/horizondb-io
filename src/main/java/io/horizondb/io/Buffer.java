...
public interface Buffer extends ReadableBuffer, WritableBuffer, SliceableBuffer {
     ...
     * 
     * <p>
     * If this method returns <tt>true</tt> then the {@link #array() array} and {@link #arrayOffset() arrayOffset}
     ...
     * 
     * <p>
     * The {@link #hasArray hasArray} method must be invoked before this method in order to ensure that this buffer has
     * a backing array.
     * </p>
     * 
