...
final class BigEndian extends Endianness {
    ...
    public void writeShort(ByteWriter writer, short s) throws IOException {
        writer.writeByte((byte) (s >>> 8)).writeByte((byte) s);
    }
    ...
    public void setShort(WritableBuffer buffer, int index, short s) {
        buffer.setByte(index, (byte) (s >>> 8)).setByte(index + 1, s);
    }
    ...
    public int readInt(ByteReader reader) throws IOException {
        ...
        return (reader.readByte() & 0xff) << 24 | (reader.readByte() & 0xff) << 16 | (reader.readByte() & 0xff) << 8
    ...
    public int getInt(ReadableBuffer buffer, int index) {
        ...
        return (buffer.getByte(index) & 0xff) << 24 | (buffer.getByte(index + 1) & 0xff) << 16
                | (buffer.getByte(index + 2) & 0xff) << 8 | (buffer.getByte(index + 3) & 0xff);
    }
    ...
    public long readLong(ByteReader reader) throws IOException {
        ...
        return ((long) reader.readByte() & 0xff) << 56 | ((long) reader.readByte() & 0xff) << 48
                | ((long) reader.readByte() & 0xff) << 40 | ((long) reader.readByte() & 0xff) << 32
                | ((long) reader.readByte() & 0xff) << 24 | ((long) reader.readByte() & 0xff) << 16
                | ((long) reader.readByte() & 0xff) << 8 | ((long) reader.readByte() & 0xff);
    }
    ...
    public long getLong(ReadableBuffer buffer, int index) {
        ...
        return ((long) buffer.getByte(index) & 0xff) << 56 | ((long) buffer.getByte(index + 1) & 0xff) << 48
                | ((long) buffer.getByte(index + 2) & 0xff) << 40 | ((long) buffer.getByte(index + 3) & 0xff) << 32
                | ((long) buffer.getByte(index + 4) & 0xff) << 24 | ((long) buffer.getByte(index + 5) & 0xff) << 16
                | ((long) buffer.getByte(index + 6) & 0xff) << 8 | ((long) buffer.getByte(index + 7) & 0xff);
    }
